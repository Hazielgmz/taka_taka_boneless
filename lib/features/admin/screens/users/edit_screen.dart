...
class _UserEditScreenState extends State<UserEditScreen> {
  ...
  void initState() {
    ...
    _employeeNumberController = TextEditingController(text: widget.user['employeeNumber']);
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            custom.AppBar(title: 'Editar Usuario', showBack: true),
            Expanded(
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                if (_formKey.currentState!.validate()) {
                                  ...
                                  widget.user['employeeNumber'] = _employeeNumberController.text;
                                  widget.user['password'] = _passwordController.text;
                                  widget.user['role'] = _selectedRole;
                                  widget.user['status'] = _selectedStatus;
